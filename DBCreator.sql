...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "PRIMARY" ON "CATEGORIES" ("ID") 
...
--------------------------------------------------------
  ...
  ALTER TABLE "CATEGORIES" ADD CONSTRAINT "PRIMARY" PRIMARY KEY ("ID")
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "PRIMARY_1" ON "COMMENTS" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "COMMENTS" MODIFY ("BODY" NOT NULL ENABLE);
  ALTER TABLE "COMMENTS" MODIFY ("DATEPOSTED" NOT NULL ENABLE);
  ALTER TABLE "COMMENTS" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "COMMENTS" MODIFY ("POSTEDBY" NOT NULL ENABLE);
  ALTER TABLE "COMMENTS" MODIFY ("VIDEOID" NOT NULL ENABLE);
  ALTER TABLE "COMMENTS" ADD CONSTRAINT "PRIMARY_1" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "PRIMARY_2" ON "DISLIKES" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "DISLIKES" MODIFY ("COMMENTID" NOT NULL ENABLE);
  ALTER TABLE "DISLIKES" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "DISLIKES" MODIFY ("USERNAME" NOT NULL ENABLE);
  ALTER TABLE "DISLIKES" MODIFY ("VIDEOID" NOT NULL ENABLE);
  ALTER TABLE "DISLIKES" ADD CONSTRAINT "PRIMARY_2" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS"  ENABLE;
--------------------------------------------------------
--  DDL for Table LIKES
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "PRIMARY_7" ON "LIKES" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "LIKES" MODIFY ("COMMENTID" NOT NULL ENABLE);
  ALTER TABLE "LIKES" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "LIKES" MODIFY ("USERNAME" NOT NULL ENABLE);
  ALTER TABLE "LIKES" MODIFY ("VIDEOID" NOT NULL ENABLE);
  ALTER TABLE "LIKES" ADD CONSTRAINT "PRIMARY_7" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "PRIMARY_4" ON "SUBSCRIBERS" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SUBSCRIBERS" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SUBSCRIBERS" MODIFY ("USERFROM" NOT NULL ENABLE);
  ALTER TABLE "SUBSCRIBERS" MODIFY ("USERTO" NOT NULL ENABLE);
  ALTER TABLE "SUBSCRIBERS" ADD CONSTRAINT "PRIMARY_4" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS"  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "PRIMARY_5" ON "THUMBNAILS" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "THUMBNAILS_TRG" 
...
END;
/
ALTER TRIGGER "THUMBNAILS_TRG" ENABLE;
--------------------------------------------------------
--  Constraints for Table THUMBNAILS
--------------------------------------------------------

  ALTER TABLE "THUMBNAILS" MODIFY ("FILEPATH" NOT NULL ENABLE);
  ALTER TABLE "THUMBNAILS" MODIFY ("SELECTED" NOT NULL ENABLE);
  ALTER TABLE "THUMBNAILS" MODIFY ("VIDEOID" NOT NULL ENABLE);
  ALTER TABLE "THUMBNAILS" ADD CONSTRAINT "PRIMARY_5" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "PRIMARY_6" ON "USERS" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "USERS" MODIFY ("FIRSTNAME" NOT NULL ENABLE);
  ALTER TABLE "USERS" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "USERS" MODIFY ("LASTNAME" NOT NULL ENABLE);
  ALTER TABLE "USERS" MODIFY ("PASSWORD" NOT NULL ENABLE);
  ALTER TABLE "USERS" MODIFY ("PROFILEPIC" NOT NULL ENABLE);
  ALTER TABLE "USERS" MODIFY ("SIGNUPDATE" NOT NULL ENABLE);
  ALTER TABLE "USERS" MODIFY ("USERNAME" NOT NULL ENABLE);
  ALTER TABLE "USERS" ADD CONSTRAINT "PRIMARY_6" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "PRIMARY_3" ON "VIDEOS" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "VIDEOS_TRG" 
...
END;
/
ALTER TRIGGER "VIDEOS_TRG" ENABLE;
--------------------------------------------------------
--  Constraints for Table VIDEOS
--------------------------------------------------------

  ALTER TABLE "VIDEOS" MODIFY ("CATEGORY" NOT NULL ENABLE);
  ALTER TABLE "VIDEOS" MODIFY ("FILEPATH" NOT NULL ENABLE);
  ALTER TABLE "VIDEOS" MODIFY ("PRIVACY" NOT NULL ENABLE);
  ALTER TABLE "VIDEOS" MODIFY ("TITLE" NOT NULL ENABLE);
  ALTER TABLE "VIDEOS" MODIFY ("UPLOADDATE" NOT NULL ENABLE);
  ALTER TABLE "VIDEOS" MODIFY ("UPLOADEDBY" NOT NULL ENABLE);
  ALTER TABLE "VIDEOS" ADD CONSTRAINT "PRIMARY_3" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SEQUENCE1"  MINVALUE 200 MAXVALUE 99999999 INCREMENT BY 1 START WITH 220 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
      
   CREATE SEQUENCE  "SEQUENCE2"  MINVALUE 70 MAXVALUE 9999999 INCREMENT BY 1 START WITH 90 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
